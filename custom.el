(custom-set-faces
 ...
 '(rainbow-delimiters-depth-2-face ((t (:foreground "gray90"))))
 '(rainbow-delimiters-depth-3-face ((t (:foreground "gray80"))))
 '(rainbow-delimiters-depth-4-face ((t (:foreground "gray70"))))
 '(rainbow-delimiters-depth-5-face ((t (:foreground "gray60"))))
 '(rainbow-delimiters-depth-6-face ((t (:foreground "gray50"))))
 '(rainbow-delimiters-depth-7-face ((t (:foreground "gray40"))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "gray30"))))
 '(rainbow-delimiters-depth-9-face ((t (:foreground "gray20"))))
 '(rainbow-delimiters-unmatched-face ((t (:foreground "gray10"))))
